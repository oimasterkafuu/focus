...
async function fetchChatGPT(text) {
    const raw = JSON.stringify({
        ...
        messages: [
            {
                role: 'user',
                content: `You are the assistant of the FOCUS app. The user will provide you his/her tasks. You should answer in a json array where each item is in the format {"time": "Time required in minutes", "detail": "Single step task required to complete"}.
